        ...
        <div class="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div class="space-y-8 relative">
            ...
            <p class="text-gray-400 text-lg leading-relaxed transform translate-y-full opacity-0" #description>
              A 23 Years Old Moroccan Programmer Specializing in Java Spring Boot and Angular development. 
            ...
            <div class="flex items-center space-x-6 transform translate-y-full opacity-0" #social>
              <a href="https://github.com/HamzaMeski" 
                 class="group relative flex items-center text-gray-400 hover:text-[#00ff88] transition-colors duration-300">
              ...
              <a href="https://linkedin.com/in/hamza-meski/"
                 class="group relative flex items-center text-gray-400 hover:text-[#00ff88] transition-colors duration-300">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="mailto:meskihamza5@gmail.com" 
                 class="group relative flex items-center text-gray-400 hover:text-[#00ff88] transition-all duration-300">
                <div class="relative">
                  <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                  </svg>
                  <span class="absolute -top-1 -right-1 w-2 h-2 bg-[#00ff88] rounded-full shadow-[0_0_8px_#00ff88] animate-pulse"></span>
                </div>
                <div class="absolute left-1/2 -translate-x-1/2 -bottom-12 px-3 py-2 bg-black/90 rounded-lg border border-[#00ff88]/20 opacity-0 group-hover:opacity-100 transition-all duration-300 backdrop-blur-sm">
                  <p class="text-[#00ff88] text-sm font-mono whitespace-nowrap">meskihamza5&#64;gmail.com</p>
                  <div class="absolute -top-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-black/90 border-l border-t border-[#00ff88]/20 rotate-45"></div>
                </div>
              </a>
            </div>
          </div>
